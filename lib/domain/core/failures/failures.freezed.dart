...
class _$ServerErrorImpl implements ServerError {
  const _$ServerErrorImpl({required this.errorMsg});
  ...
  @override
  String toString() {
    return 'MainFailure.serverError(errorMsg: $errorMsg)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return serverError?.call(errorMsg);
  }
...
abstract class ServerError implements MainFailure {
  const factory ServerError({required final String errorMsg}) =
      _$ServerErrorImpl;
